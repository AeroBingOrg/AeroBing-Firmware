...
#define RING_BUF_CAPACITY 400 * 512 // this is what's causing the memory overflow, but when shart actually runs i dont think it will be an issue cuz there will be enough memory for it
